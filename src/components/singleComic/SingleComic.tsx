        ...
        return (
            <div className="single-comic">
                ...
                <div className="single-comic__info">
                    ...
                    <p className="single-comic__descr">Re-live the legendary first journey into the dystopian future of
                        ...
                        the X-Men from Cyclops himself...and a demon for Christmas!?</p>
